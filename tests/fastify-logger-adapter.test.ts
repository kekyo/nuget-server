...
describe('FastifyLoggerAdapter', () => {
  ...
  describe('Object logging', () => {
    ...
    it('should combine object and message', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('request received ' + JSON.stringify(obj));
    });
  ...
  describe('Complex scenarios', () => {
    it('should handle nested objects', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('nested object ' + JSON.stringify(nested));
    });
    ...
    it('should handle non-Error objects in err field', () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith('Custom error: {"custom":"error"}');
    });
  });
