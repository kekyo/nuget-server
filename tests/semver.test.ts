...
import { compareVersions, sortVersions, getLatestVersion } from '../src/utils/semver';
...
describe('Semantic Version Utilities', () => {
  ...
  describe('sortVersions', () => {
    it('should sort versions in descending order by default', () => {
      ...
      expect(sorted).toEqual(['2.0.0', '1.10.0', '1.9.0', '1.0.0', '1.0.0-alpha']);
    });
    ...
    it('should handle complex version numbers', () => {
      const versions = ['1.0.0', '1.0.0-alpha.1', '1.0.0-alpha.2', '1.0.0-beta', '1.0.1'];
      const sorted = sortVersions(versions);
      expect(sorted).toEqual(['1.0.1', '1.0.0', '1.0.0-beta', '1.0.0-alpha.2', '1.0.0-alpha.1']);
    });
