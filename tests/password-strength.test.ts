...
import { checkPasswordStrength, getMinPasswordScore } from '../src/utils/passwordStrength';
...
describe('Password Strength', () => {
  describe('checkPasswordStrength', () => {
    ...
    it('should detect very strong passwords', () => {
      const result = checkPasswordStrength('Th1s!Is@Really#Complex$Password%2024^With&Many*Characters');
